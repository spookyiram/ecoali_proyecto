      ...
      <div class="login-card">
        ...
        <div class="header-content">
          <div class="div-wrapper">
            <div class="div">Verificar correo</div>
          </div>
          <p class="p">
        ...
        <div class="form-margin">
          <form action="forms/validar_codigo.php" method="POST" class="form">

            <div class="container-2">
              <div class="label-margin">
                <div class="div-2">
                  <div class="text-wrapper-2">Código de verificación</div>
                </div>
              </div>
            ...
            <div class="action-button-margin">
              <button class="action-button" type="submit">
                ...
                <div class="text-wrapper-3">Validar código</div>
              </button>
            </div>
